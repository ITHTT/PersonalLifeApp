package com.htt.personallife.views.widgets.chatviews.utils;
...
import com.htt.emoticonskeyboard.data.EmoticonPageSetEntity;
import com.htt.emoticonskeyboard.interfaces.EmoticonClickListener;
import com.htt.emoticonskeyboard.interfaces.EmoticonDisplayListener;
import com.htt.emoticonskeyboard.interfaces.PageViewInstantiateListener;
import com.htt.emoticonskeyboard.utils.imageloader.ImageBase;
import com.htt.emoticonskeyboard.utils.imageloader.ImageLoader;
    ...
    public static EmoticonClickListener getCommonEmoticonClickListener(final EditText editText) {
        return new EmoticonClickListener() {
            ...
            public void onEmoticonClick(Object o, int actionType, boolean isDelBtn) {
                if (isDelBtn) {
                    ChatCommonUtils.delClick(editText);
                } else {
                    if (o == null) {
                        return;
                    }
