...
public class SmoothCheckBox extends View implements Checkable {
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB) private void startCheckedAnimation() {
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB) private void startUnCheckedAnimation() {
