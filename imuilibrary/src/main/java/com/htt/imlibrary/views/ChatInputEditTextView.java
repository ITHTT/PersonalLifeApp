...
import com.htt.imlibrary.views.widget.EmoticonsFuncView;
import com.htt.imlibrary.views.widget.EmoticonsIndicatorView;
import com.htt.imlibrary.views.widget.EmoticonsToolBarView;
...
public class ChatInputEditTextView extends AutoHeightLayout implements View.OnClickListener, EmoticonsFuncView.OnEmoticonsPageViewListener,
    ...
    public ChatInputEditTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initEmoticonFuncView(){
        View keyboardView = mInflater.inflate(R.layout.layout_emoticon_view,null);
